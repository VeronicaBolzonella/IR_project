# Entire library taken and adapted from https://github.com/Ybakman/TruthTorchLM/blob/main/src/TruthTorchLM/long_form_generation/evaluators/eval_claim.py
...
# CHANGE  THIS TO RERANK????
# FOR DEBUGGIG ONLY USE BM25

# IF WANT TO CHANGE FAST CHANGE IT IN LATER FUNCTIONS AS WELL WHEN CALLING RERANK

def call_search(
    search_query: str,
    num_searches: int = 3,
    search_postamble: str = "",  # ex: 'site:https://en.wikipedia.org'
    # NEW ADDITION -> FAST=ONLY BM25
    fast = True,
) -> str:
